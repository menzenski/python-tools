...
class RussianWord(object):
    ...
    def general_corpus_search(self):
        search_url_begin = (
            ...
            "alpha&mycorp=%28%28created%253A%253C%253D%25221799%2522%2520"
            "%7E%7E%2520created%253A%253E%25221799%2522%29%29&mysent="
            "&mysize=3368591&mysentsize=194374&mydocsize=1266&spd=&text="
...
def main_four():
    for lemma in lemmas:
        for form in forms:
            ...
            search.general_corpus_search()
            search.get_sources_onepage()
            search.seriously_get_all_pages()
            search.find_bare_tokens()
